...
object ActiveSubscriptionPreference {
  ...
  class ViewHolder(itemView: View) : MappingViewHolder<Model>(itemView) {
    ...
    private fun presentPaymentFailureState(model: Model) {
      expiry.text = context.getString(R.string.DonationsErrors__error_processing_payment_s, context.getString(R.string.MySupportPreference__please_contact_support))
      badge.alpha = 0.2f
      progress.visible = false
    }

    private fun presentRedemptionFailureState(model: Model) {
      expiry.text = context.getString(R.string.MySupportPreference__couldnt_add_badge_s, context.getString(R.string.MySupportPreference__please_contact_support))
      badge.alpha = 0.2f
      progress.visible = false
    }
  }
